  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="mx-auto max-w-4xl flex-1 px-4 py-12 sm:px-6 lg:px-8 space-y-8">
        <div>
          <h1 className="font-serif text-3xl font-bold text-slate-900">About {settings.store_name}</h1>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-8 space-y-6 text-xs text-slate-700 leading-relaxed">
          <p>
            Founded in {settings.city}, <strong>{settings.store_name}</strong> was established out of a quiet reverence for tactile handwriting and thoughtful daily rituals. We believe that writing on 100gsm fountain-pen friendly cotton paper with a well-balanced instrument brings clarity, focus, and enduring pleasure to work and personal reflection.
          </p>
          <p>
